...
{id:'fruits',title:'100 Fruits',icon:'🥭',description:'Learn 100 fruit names in Kannada and English.',items:[{id:'kf1',picture:'🥭',word:'ಮಾವು',meaning:'Mango',example:'ಮಾವು — Mango'},{id:'kf2',picture:'🍎',word:'ಸೇಬು',meaning:'Apple',example:'ಸೇಬು — Apple'},{id:'kf3',picture:'🍌',word:'ಬಾಳೆಹಣ್ಣು',meaning:'Banana',example:'ಬಾಳೆಹಣ್ಣು — Banana'},{id:'kf4',picture:'🍊',word:'ಕಿತ್ತಳೆ',meaning:'Orange',example:'ಕಿತ್ತಳೆ — Orange'},{id:'kf5',picture:'🍇',word:'ದ್ರಾಕ್ಷಿ',meaning:'Grapes',example:'ದ್ರಾಕ್ಷಿ — Grapes'},{id:'kf6',picture:'🍉',word:'ಕಲ್ಲಂಗಡಿ',meaning:'Watermelon',example:'ಕಲ್ಲಂಗಡಿ — Watermelon'},{id:'kf7',picture:'🍈',word:'ಕರಬೂಜ',meaning:'Muskmelon',example:'ಕರಬೂಜ — Muskmelon'},{id:'kf8',picture:'🍍',word:'ಅನಾನಸ್',meaning:'Pineapple',example:'ಅನಾನಸ್ — Pineapple'},{id:'kf9',picture:'🥥',word:'ತೆಂಗಿನಕಾಯಿ',meaning:'Coconut',example:'ತೆಂಗಿನಕಾಯಿ — Coconut'},{id:'kf10',picture:'🍋',word:'ನಿಂಬೆಹಣ್ಣು',meaning:'Lemon',example:'ನಿಂಬೆಹಣ್ಣು — Lemon'},{id:'kf11',picture:'🍋',word:'ಮೋಸಂಬಿ',meaning:'Sweet lime',example:'ಮೋಸಂಬಿ — Sweet lime'},{id:'kf12',picture:'🍐',word:'ಪಿಯರ್ ಹಣ್ಣು',meaning:'Pear',example:'ಪಿಯರ್ ಹಣ್ಣು — Pear'},{id:'kf13',picture:'🍑',word:'ಪೀಚ್',meaning:'Peach',example:'ಪೀಚ್ — Peach'},{id:'kf14',picture:'🍒',word:'ಚೆರ್ರಿ',meaning:'Cherry',example:'ಚೆರ್ರಿ — Cherry'},{id:'kf15',picture:'🍓',word:'ಸ್ಟ್ರಾಬೆರಿ',meaning:'Strawberry',example:'ಸ್ಟ್ರಾಬೆರಿ — Strawberry'},{id:'kf16',picture:'🫐',word:'ಬ್ಲೂಬೆರಿ',meaning:'Blueberry',example:'ಬ್ಲೂಬೆರಿ — Blueberry'},{id:'kf17',picture:'🫐',word:'ಬ್ಲ್ಯಾಕ್‌ಬೆರಿ',meaning:'Blackberry',example:'ಬ್ಲ್ಯಾಕ್‌ಬೆರಿ — Blackberry'},{id:'kf18',picture:'🍇',word:'ರಾಸ್ಪ್‌ಬೆರಿ',meaning:'Raspberry',example:'ರಾಸ್ಪ್‌ಬೆರಿ — Raspberry'},{id:'kf19',picture:'🥝',word:'ಕಿವಿ ಹಣ್ಣು',meaning:'Kiwi',example:'ಕಿವಿ ಹಣ್ಣು — Kiwi'},{id:'kf20',picture:'🍎',word:'ದಾಳಿಂಬೆ',meaning:'Pomegranate',example:'ದಾಳಿಂಬೆ — Pomegranate'},{id:'kf21',picture:'🍈',word:'ಪಪ್ಪಾಯಿ',meaning:'Papaya',example:'ಪಪ್ಪಾಯಿ — Papaya'},{id:'kf22',picture:'🥭',word:'ಸೀಬೆಹಣ್ಣು',meaning:'Guava',example:'ಸೀಬೆಹಣ್ಣು — Guava'},{id:'kf23',picture:'🍈',word:'ಸೀತಾಫಲ',meaning:'Custard apple',example:'ಸೀತಾಫಲ — Custard apple'},{id:'kf24',picture:'🍈',word:'ರಾಮಫಲ',meaning:'Bullock\'s heart',example:'ರಾಮಫಲ — Bullock\'s heart'},{id:'kf25',picture:'🍈',word:'ಹನುಮಾನ್ ಫಲ',meaning:'Soursop',example:'ಹನುಮಾನ್ ಫಲ — Soursop'},{id:'kf26',picture:'🍈',word:'ಚಿಕ್ಕು',meaning:'Sapota',example:'ಚಿಕ್ಕು — Sapota'},{id:'kf27',picture:'🍈',word:'ಹಲಸಿನಹಣ್ಣು',meaning:'Jackfruit',example:'ಹಲಸಿನಹಣ್ಣು — Jackfruit'},{id:'kf28',picture:'🍈',word:'ಬ್ರೆಡ್‌ಫ್ರೂಟ್',meaning:'Breadfruit',example:'ಬ್ರೆಡ್‌ಫ್ರೂಟ್ — Breadfruit'},{id:'kf29',picture:'🍑',word:'ಪ್ಲಮ್',meaning:'Plum',example:'ಪ್ಲಮ್ — Plum'},{id:'kf30',picture:'🍑',word:'ಅಪ್ರಿಕಾಟ್',meaning:'Apricot',example:'ಅಪ್ರಿಕಾಟ್ — Apricot'},{id:'kf31',picture:'🍑',word:'ನೆಕ್ಟರಿನ್',meaning:'Nectarine',example:'ನೆಕ್ಟರಿನ್ — Nectarine'},{id:'kf32',picture:'🍊',word:'ಗ್ರೇಪ್‌ಫ್ರೂಟ್',meaning:'Grapefruit',example:'ಗ್ರೇಪ್‌ಫ್ರೂಟ್ — Grapefruit'},{id:'kf33',picture:'🍊',word:'ಮ್ಯಾಂಡರಿನ್',meaning:'Mandarin',example:'ಮ್ಯಾಂಡರಿನ್ — Mandarin'},{id:'kf34',picture:'🍊',word:'ಟ್ಯಾಂಗರಿನ್',meaning:'Tangerine',example:'ಟ್ಯಾಂಗರಿನ್ — Tangerine'},{id:'kf35',picture:'🍊',word:'ಪೊಮೆಲೊ',meaning:'Pomelo',example:'ಪೊಮೆಲೊ — Pomelo'},{id:'kf36',picture:'🍋',word:'ಸಿಟ್ರಾನ್',meaning:'Citron',example:'ಸಿಟ್ರಾನ್ — Citron'},{id:'kf37',picture:'🍋',word:'ಕಾಫಿರ್ ಲೈಮ್',meaning:'Kaffir lime',example:'ಕಾಫಿರ್ ಲೈಮ್ — Kaffir lime'},{id:'kf38',picture:'🍋',word:'ಕೀ ಲೈಮ್',meaning:'Key lime',example:'ಕೀ ಲೈಮ್ — Key lime'},{id:'kf39',picture:'🍎',word:'ನೆಲ್ಲಿಕಾಯಿ',meaning:'Indian gooseberry',example:'ನೆಲ್ಲಿಕಾಯಿ — Indian gooseberry'},{id:'kf40',picture:'🍒',word:'ನೇರಳೆಹಣ್ಣು',meaning:'Java plum',example:'ನೇರಳೆಹಣ್ಣು — Java plum'},{id:'kf41',picture:'🍒',word:'ಬೋರೆಹಣ್ಣು',meaning:'Indian jujube',example:'ಬೋರೆಹಣ್ಣು — Indian jujube'},{id:'kf42',picture:'🍒',word:'ಚೆರ್ರಿ ಪ್ಲಮ್',meaning:'Cherry plum',example:'ಚೆರ್ರಿ ಪ್ಲಮ್ — Cherry plum'},{id:'kf43',picture:'🍇',word:'ಕಪ್ಪು ದ್ರಾಕ್ಷಿ',meaning:'Black grapes',example:'ಕಪ್ಪು ದ್ರಾಕ್ಷಿ — Black grapes'},{id:'kf44',picture:'🍇',word:'ಹಸಿರು ದ್ರಾಕ್ಷಿ',meaning:'Green grapes',example:'ಹಸಿರು ದ್ರಾಕ್ಷಿ — Green grapes'},{id:'kf45',picture:'🍇',word:'ಕೆಂಪು ದ್ರಾಕ್ಷಿ',meaning:'Red grapes',example:'ಕೆಂಪು ದ್ರಾಕ್ಷಿ — Red grapes'},{id:'kf46',picture:'🍉',word:'ಹಳದಿ ಕಲ್ಲಂಗಡಿ',meaning:'Yellow watermelon',example:'ಹಳದಿ ಕಲ್ಲಂಗಡಿ — Yellow watermelon'},{id:'kf47',picture:'🍈',word:'ಹನಿ ಡ್ಯೂ ಮೆಲನ್',meaning:'Honeydew melon',example:'ಹನಿ ಡ್ಯೂ ಮೆಲನ್ — Honeydew melon'},{id:'kf48',picture:'🍈',word:'ಕ್ಯಾಂಟಲೂಪ್',meaning:'Cantaloupe',example:'ಕ್ಯಾಂಟಲೂಪ್ — Cantaloupe'},{id:'kf49',picture:'🐉',word:'ಡ್ರ್ಯಾಗನ್ ಹಣ್ಣು',meaning:'Dragon fruit',example:'ಡ್ರ್ಯಾಗನ್ ಹಣ್ಣು — Dragon fruit'},{id:'kf50',picture:'⭐',word:'ಸ್ಟಾರ್ ಫ್ರೂಟ್',meaning:'Star fruit',example:'ಸ್ಟಾರ್ ಫ್ರೂಟ್ — Star fruit'},{id:'kf51',picture:'🍈',word:'ಪ್ಯಾಷನ್ ಫ್ರೂಟ್',meaning:'Passion fruit',example:'ಪ್ಯಾಷನ್ ಫ್ರೂಟ್ — Passion fruit'},{id:'kf52',picture:'🍈',word:'ಲಿಚಿ',meaning:'Lychee',example:'ಲಿಚಿ — Lychee'},{id:'kf53',picture:'🍈',word:'ಲಾಂಗನ್',meaning:'Longan',example:'ಲಾಂಗನ್ — Longan'},{id:'kf54',picture:'🍈',word:'ರಾಂಬುಟಾನ್',meaning:'Rambutan',example:'ರಾಂಬುಟಾನ್ — Rambutan'},{id:'kf55',picture:'🍈',word:'ಮ್ಯಾಂಗೋಸ್ಟೀನ್',meaning:'Mangosteen',example:'ಮ್ಯಾಂಗೋಸ್ಟೀನ್ — Mangosteen'},{id:'kf56',picture:'🍈',word:'ದುರಿಯನ್',meaning:'Durian',example:'ದುರಿಯನ್ — Durian'},{id:'kf57',picture:'🍈',word:'ಪರ್ಸಿಮನ್',meaning:'Persimmon',example:'ಪರ್ಸಿಮನ್ — Persimmon'},{id:'kf58',picture:'🍈',word:'ಅವಕಾಡೊ',meaning:'Avocado',example:'ಅವಕಾಡೊ — Avocado'},{id:'kf59',picture:'🍈',word:'ಅಂಜೂರ',meaning:'Fig',example:'ಅಂಜೂರ — Fig'},{id:'kf60',picture:'🌴',word:'ಖರ್ಜೂರ',meaning:'Date',example:'ಖರ್ಜೂರ — Date'},{id:'kf61',picture:'🍇',word:'ಒಣದ್ರಾಕ್ಷಿ',meaning:'Raisin',example:'ಒಣದ್ರಾಕ್ಷಿ — Raisin'},{id:'kf62',picture:'🍒',word:'ಕ್ರ್ಯಾನ್‌ಬೆರಿ',meaning:'Cranberry',example:'ಕ್ರ್ಯಾನ್‌ಬೆರಿ — Cranberry'},{id:'kf63',picture:'🍒',word:'ಗೂಸ್‌ಬೆರಿ',meaning:'Gooseberry',example:'ಗೂಸ್‌ಬೆರಿ — Gooseberry'},{id:'kf64',picture:'🍒',word:'ರೆಡ್ ಕರಂಟ್',meaning:'Red currant',example:'ರೆಡ್ ಕರಂಟ್ — Red currant'},{id:'kf65',picture:'🍒',word:'ಬ್ಲ್ಯಾಕ್ ಕರಂಟ್',meaning:'Black currant',example:'ಬ್ಲ್ಯಾಕ್ ಕರಂಟ್ — Black currant'},{id:'kf66',picture:'🍒',word:'ವೈಟ್ ಕರಂಟ್',meaning:'White currant',example:'ವೈಟ್ ಕರಂಟ್ — White currant'},{id:'kf67',picture:'🍒',word:'ಎಲ್ಡರ್‌ಬೆರಿ',meaning:'Elderberry',example:'ಎಲ್ಡರ್‌ಬೆರಿ — Elderberry'},{id:'kf68',picture:'🍒',word:'ಮಲ್ಬೆರಿ',meaning:'Mulberry',example:'ಮಲ್ಬೆರಿ — Mulberry'},{id:'kf69',picture:'🍒',word:'ಅಕಾಯಿ ಬೆರಿ',meaning:'Acai berry',example:'ಅಕಾಯಿ ಬೆರಿ — Acai berry'},{id:'kf70',picture:'🍒',word:'ಗೋಜಿ ಬೆರಿ',meaning:'Goji berry',example:'ಗೋಜಿ ಬೆರಿ — Goji berry'},{id:'kf71',picture:'🍒',word:'ಬಾಯ್ಸೆನ್‌ಬೆರಿ',meaning:'Boysenberry',example:'ಬಾಯ್ಸೆನ್‌ಬೆರಿ — Boysenberry'},{id:'kf72',picture:'🍒',word:'ಲೋಗನ್‌ಬೆರಿ',meaning:'Loganberry',example:'ಲೋಗನ್‌ಬೆರಿ — Loganberry'},{id:'kf73',picture:'🍒',word:'ಹಕಲ್‌ಬೆರಿ',meaning:'Huckleberry',example:'ಹಕಲ್‌ಬೆರಿ — Huckleberry'},{id:'kf74',picture:'🍒',word:'ಕ್ಲೌಡ್‌ಬೆರಿ',meaning:'Cloudberry',example:'ಕ್ಲೌಡ್‌ಬೆರಿ — Cloudberry'},{id:'kf75',picture:'🍒',word:'ಜುನಿಪರ್ ಬೆರಿ',meaning:'Juniper berry',example:'ಜುನಿಪರ್ ಬೆರಿ — Juniper berry'},{id:'kf76',picture:'🍈',word:'ಕ್ವಿನ್ಸ್',meaning:'Quince',example:'ಕ್ವಿನ್ಸ್ — Quince'},{id:'kf77',picture:'🍈',word:'ಲೋಕ್ವಾಟ್',meaning:'Loquat',example:'ಲೋಕ್ವಾಟ್ — Loquat'},{id:'kf78',picture:'🍈',word:'ಮೆಡ್ಲರ್',meaning:'Medlar',example:'ಮೆಡ್ಲರ್ — Medlar'},{id:'kf79',picture:'🍈',word:'ಸಲಾಕ್',meaning:'Snake fruit',example:'ಸಲಾಕ್ — Snake fruit'},{id:'kf80',picture:'🍈',word:'ಲಾಂಗ್ಸಾಟ್',meaning:'Langsat',example:'ಲಾಂಗ್ಸಾಟ್ — Langsat'},{id:'kf81',picture:'🍈',word:'ಸಾಂತೋಲ್',meaning:'Santol',example:'ಸಾಂತೋಲ್ — Santol'},{id:'kf82',picture:'🍈',word:'ಚೆರಿಮೋಯಾ',meaning:'Cherimoya',example:'ಚೆರಿಮೋಯಾ — Cherimoya'},{id:'kf83',picture:'🍈',word:'ಅಟೆಮೊಯಾ',meaning:'Atemoya',example:'ಅಟೆಮೊಯಾ — Atemoya'},{id:'kf84',picture:'🍈',word:'ಫೀಜೋವಾ',meaning:'Feijoa',example:'ಫೀಜೋವಾ — Feijoa'},{id:'kf85',picture:'🍈',word:'ತಮರಿಲ್ಲೊ',meaning:'Tamarillo',example:'ತಮರಿಲ್ಲೊ — Tamarillo'},{id:'kf86',picture:'🍈',word:'ಕಿವಾನೊ',meaning:'Kiwano',example:'ಕಿವಾನೊ — Kiwano'},{id:'kf87',picture:'🍈',word:'ಪೆಪಿನೊ',meaning:'Pepino melon',example:'ಪೆಪಿನೊ — Pepino melon'},{id:'kf88',picture:'🍈',word:'ಮಿರಾಕಲ್ ಫ್ರೂಟ್',meaning:'Miracle fruit',example:'ಮಿರಾಕಲ್ ಫ್ರೂಟ್ — Miracle fruit'},{id:'kf89',picture:'🍈',word:'ಬೇಲ್ ಹಣ್ಣು',meaning:'Bael fruit',example:'ಬೇಲ್ ಹಣ್ಣು — Bael fruit'},{id:'kf90',picture:'🍈',word:'ವುಡ್ ಆಪಲ್',meaning:'Wood apple',example:'ವುಡ್ ಆಪಲ್ — Wood apple'},{id:'kf91',picture:'🍈',word:'ಕೊಕುಮ್',meaning:'Kokum',example:'ಕೊಕುಮ್ — Kokum'},{id:'kf92',picture:'🍈',word:'ಕಮರಖ',meaning:'Carambola',example:'ಕಮರಖ — Carambola'},{id:'kf93',picture:'🍈',word:'ತಾಳೆಹಣ್ಣು',meaning:'Palmyra fruit',example:'ತಾಳೆಹಣ್ಣು — Palmyra fruit'},{id:'kf94',picture:'🍈',word:'ಐಸ್ ಆಪಲ್',meaning:'Ice apple',example:'ಐಸ್ ಆಪಲ್ — Ice apple'},{id:'kf95',picture:'🍈',word:'ನೋನಿ',meaning:'Noni',example:'ನೋನಿ — Noni'},{id:'kf96',picture:'🍈',word:'ಮಂಕಿ ಜಾಕ್',meaning:'Monkey jack',example:'ಮಂಕಿ ಜಾಕ್ — Monkey jack'},{id:'kf97',picture:'🍈',word:'ಬಿಲಿಂಬಿ',meaning:'Bilimbi',example:'ಬಿಲಿಂಬಿ — Bilimbi'},{id:'kf98',picture:'🍈',word:'ಅಂಬರೆಲ್ಲಾ',meaning:'Ambarella',example:'ಅಂಬರೆಲ್ಲಾ — Ambarella'},{id:'kf99',picture:'🍈',word:'ಮರಿಯನ್ ಪ್ಲಮ್',meaning:'Marian plum',example:'ಮರಿಯನ್ ಪ್ಲಮ್ — Marian plum'},{id:'kf100',picture:'🍈',word:'ಜಬುಟಿಕಾಬಾ',meaning:'Jabuticaba',example:'ಜಬುಟಿಕಾಬಾ — Jabuticaba'}]}
],stories:[
